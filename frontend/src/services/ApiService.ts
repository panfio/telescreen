...
export const apiService = {
  ...
  async getYouTubes(startDate: Date, endDate: Date): Promise<ReadonlyArray<IYouTubeRecord>> {
    const response = await fetch(`${host}/api/video/youtube?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getTimeLogs(startDate: Date, endDate: Date): Promise<ReadonlyArray<ITimeLogRecord>> {
    const response = await fetch(`${host}/api/timelog?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getAutotimers(startDate: Date, endDate: Date): Promise<ReadonlyArray<IAutoTimerRecord>> {
    const response = await fetch(`${host}/api/autotimer?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getListenHistory(startDate: Date, endDate: Date): Promise<ReadonlyArray<IListenRecord>> {
    const response = await fetch(`${host}/api/music?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getMediaHistory(startDate: Date, endDate: Date): Promise<ReadonlyArray<IMediaRecord>> {
    const response = await fetch(`${host}/api/media?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getWellbeingHistory(startDate: Date, endDate: Date): Promise<ReadonlyArray<IWellbeingRecord>> {
    const response = await fetch(`${host}/api/wellbeing?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getMessageHistory(startDate: Date, endDate: Date): Promise<ReadonlyArray<IMessageRecord>> {
    const response = await fetch(`${host}/api/message?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getCallHistory(startDate: Date, endDate: Date): Promise<ReadonlyArray<ICallRecord>> {
    const response = await fetch(`${host}/api/call?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  },

  async getMiFitActivity(startDate: Date, endDate: Date): Promise<ReadonlyArray<IMiFitActivityRecord>> {
    const response = await fetch(`${host}/api/mifit?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    return await response.json();
  }
}
